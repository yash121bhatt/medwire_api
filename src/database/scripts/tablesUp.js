...
const {
    ...
    createSymtomes,
    createHealthStatus,
    createAppointmentMeetings,
    createAppliedCouponCodes,
} = require("../queries");
...
const tableCreationQueries = [
    ...
    { name: "symptoms", query: createSymtomes },
    { name: "health_status", query: createHealthStatus },
    { name: "appointment_meetings", query: createAppointmentMeetings },
    { name: "applied_coupon_codes", query: createAppliedCouponCodes },
];
