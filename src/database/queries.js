...
CREATE TABLE IF NOT EXISTS users (
    ...
    online_offline_status varchar(255) DEFAULT NULL,
    deleted_at DATETIME,
...
const createAppointmentMeetings = `
...
const createAppliedCouponCodes = `
CREATE TABLE IF NOT EXISTS applied_coupon_codes (
    id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    user_id varchar (255) null, 
