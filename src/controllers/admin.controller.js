...
const { transporter: transporter, getCopyrightYear, uploadFileIntoCloudinary } = require("../helper/helper");
...
exports.updateUser = async (req, res) => {
    ...
    if (file == undefined) {
        ...
        var image_name = await uploadFileIntoCloudinary(req);
    }
...
exports.operaterCreate = async (req, res) => {
...
exports.operaterUpdate = async (req, res) => {
