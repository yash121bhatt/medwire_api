...
const { uniqueEmailAndMobile: uniqueEmailAndMobile, uploadFileIntoCloudinary, getCopyrightYear } = require("../helper/helper");
...
exports.radiosignup = async (req, res) => {
    ...
    var approve_document = await uploadFileIntoCloudinary(req);
...
exports.clinichospitalsignup = async (req, res) => {
    ...
    if (req.file == undefined) {
        ...
        // const approve_document = req.file.filename;
        const approve_document = await uploadFileIntoCloudinary(req);
    }
...
exports.clinichospitalprofile = (req, res) => {
    ...
    ClinicOrHospital.findByIdAndRole(clinic_id, (err, data) => {
        ...
        if (data) {
            ...
            var profile_image_path = process.env.CLOUDINARY_BASE_URL + "member/" + profile_image_name;
...
exports.updateProfile = (req, res) => {
    ...
    User.findById(req.body.user_id, async (err, data) => {
        if (err) {
            res.status(500).send({
                status_code: "500",
                status: "error",
