...
exports.create = async (req, res) => {
    ...
    Package.create(lab_id, test_category_id, test_id, test_name, package_name, test_report_time, tasting_time, test_recommended, description, image, amount, (err) => {
        if (err) {
...
exports.update = async (req, res) => {
    ...
    Package.update(test_category_id, test_id, test_name, package_name, test_report_time, tasting_time, test_recommended, description, image, amount, lab_id, package_id, (err) => {
        if (err) {
            return res.status(500).json({
                status_code: "500",
                status: "error",
