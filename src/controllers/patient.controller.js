                ...
                if (data.length > 0) {
                    ...
                    Patient.search(req.body.search_key, async (pErr, pData) => {
                        ...
                        if (pData) {
                            ...
                            db.query("Insert into users_patient(patient_id,user_id) values(?,?)", [req.body.patient_id, created_by_id], (err, res2) => {
...
exports.deletePatient = (req, res) => {
    ...
    Patient.delete(patient_id, created_by_id, (err, data) => {
        ...
        if (data) {
            if (added_by) {
                Patient.deleteStaffPatient(patient_id, added_by, (err, data) => {
                    if (err) {
                        res.status(500).send({
                            status_code: 500,
                            status: 'error',
