                                ...
                                if (labradio.length > 0) {
                                    for (const iterator of labradio) {
                                        if (iterator.type == 1) {
                                            ...
                                            lab_document_url = iterator.report_document != null ? process.env.CLOUDINARY_BASE_URL + "laboratory/" + iterator.report_document : "";
                                        }
                                        if (iterator.type == 2) {
                                            radio_document = iterator.report_document;
                                            radio_document_url = iterator.report_document != null ? process.env.CLOUDINARY_BASE_URL + "laboratory/" + iterator.report_document : "";
                ...
                if (dataDoctor) {
                    ...
                    if (data1 != null && data1 != "null" && data1 != undefined) {
                        ...
                        if (data.length > 0) {
                            ...
                            const absolutePathOfLogo = resolve(process.env.CLOUDINARY_BASE_URL + "member/" + clinic_logo);
                            ...
                            const absolutePathOfSign = resolve(process.env.CLOUDINARY_BASE_URL + "signature/" + signature);
                            ...
                            myDoc.on("end", async () => {
                                ...
                                return res.status(200).send({
                                    ...
                                    status: "success",
                                    pdf_name: pdf_name,
                                    pdf_url: process.env.CLOUDINARY_BASE_URL + "prescription_pdfs/" + pdf_name,
                                    pdf_url_for_admin: process.env.CLOUDINARY_BASE_URL + "prescription_pdfs/" + pdf_name1,
