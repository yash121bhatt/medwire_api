...
const { upload, signupload } = require("../middlewares/multerConfig.js");
...
router.route("/payment-appointment-callback").get(asyncHandler(ccavenuePayment.paymentAppointmentCallback));
...
router.route("/payment-plan-callback").get(asyncHandler(ccavenuePayment.paymentPlanCallback));
