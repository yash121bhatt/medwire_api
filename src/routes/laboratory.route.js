...
const { labUpload } = require("../middlewares/multerConfig.js");
...
router.route("/uploadReport").post(asyncHandler(jwtAuth), labUpload.single("report_document"), asyncHandler(laboratoryController.uploadReport));

router.route("/upload-multiple-report").post(asyncHandler(jwtAuth), labUpload.array("report_document"), asyncHandler(laboratoryController.uploadReportMultiple));
...
router.route("/add-lab-test").post(asyncHandler(jwtAuth), labUpload.single("image"), asyncHandler(labTestController.create));
router.route("/edit-lab-test").post(asyncHandler(jwtAuth), labUpload.single("image"), asyncHandler(labTestController.update));
...
//alltest
router.route("/add-package").post(asyncHandler(jwtAuth), labUpload.single("image"), asyncHandler(packageController.create));
router.route("/edit-package").post(asyncHandler(jwtAuth), labUpload.single("image"), asyncHandler(packageController.update));
