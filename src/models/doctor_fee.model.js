...
class DoctorFee {
    ...
    static update(doctor_id, visit_type, is_available_for_offline_visit, is_available_for_online_visit, online_consulting_fee, clinic_visit_consulting_fee, fee_id, cb) {
        db.query(
            "UPDATE doctor_fees SET doctor_id = ?, visit_type = ?, is_available_for_offline_visit = ?, is_available_for_online_visit = ?, online_consulting_fee = ? ,clinic_visit_consulting_fee = ?  WHERE id = ?",
            [doctor_id, visit_type, is_available_for_offline_visit, is_available_for_online_visit, online_consulting_fee, clinic_visit_consulting_fee, fee_id], (err) => {
                if (err) {
                    logger.error(err.message);
                    cb(err, null);
                    return;
